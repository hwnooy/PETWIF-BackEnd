...
public class FriendRestController {
    ...
    @PostMapping("/friends/{friendId}/requests")
    ...
    public ApiResponse<FriendResponseDTO.FriendResultDTO> friendRequest(@ExistMember @PathVariable(name = "friendId") Long friendId,
    ...
    @PutMapping("/friend/{friendId}/cancellations")
    ...
    public ApiResponse<FriendResponseDTO.FriendResultDTO> friendCancel(@ExistMember @PathVariable(name = "friendId") Long friendId,
                                                                       @RequestHeader("Authorization") String authorizationHeader) {
        Member member = memberService.getMemberByToken(authorizationHeader);
        Long memberId = member.getId();
    ...
    @PutMapping("/friend/{friendId}/acceptances")
    ...
    public ApiResponse<FriendResponseDTO.FriendResultDTO> friendAccept(@ExistMember @PathVariable(name = "friendId") Long friendId,
                                                                       @RequestHeader("Authorization") String authorizationHeader) {
        Member member = memberService.getMemberByToken(authorizationHeader);
        Long memberId = member.getId();
    ...
    @PutMapping("/friend/{friendId}/rejections")
    ...
    public ApiResponse<FriendResponseDTO.FriendResultDTO> friendReject(@ExistMember @PathVariable(name = "friendId") Long friendId,
                                                                       @RequestHeader("Authorization") String authorizationHeader) {
        Member member = memberService.getMemberByToken(authorizationHeader);
        Long memberId = member.getId();
    ...
    public ApiResponse<FriendResponseDTO.FriendStatusDTO> getFriendStatus(@ExistMember @PathVariable(name = "friendId") Long friendId,
                                                                          @RequestHeader("Authorization") String authorizationHeader) {
        Member member = memberService.getMemberByToken(authorizationHeader);
        Long memberId = member.getId();
    ...
    public ApiResponse<FriendResponseDTO.FriendResultDTO> deleteFriend(@ExistMember @PathVariable(name = "friendId") Long friendId,
                                                                       @RequestHeader("Authorization") String authorizationHeader) {
        Member member = memberService.getMemberByToken(authorizationHeader);
        Long memberId = member.getId();
